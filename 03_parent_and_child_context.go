...
- Parent context bisa memiliki banyak child, namun child hanya bisa memiliki satu parent
- Konsep ini mirip dengan pewarisan di pemrograman berorientasi object

Hubungan Antara Parent and Child Context
...
- Namun, jika kita menyisipkan data di context B, hanya context B dan semua child dan sub child nya yang mendapat data, parent context B tidak akan mendapatkan data
